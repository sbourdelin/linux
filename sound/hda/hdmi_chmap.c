...
static const struct hdmi_chmap_ops chmap_ops = {
	...
	.get_active_channels			= hdmi_get_active_channels,
	.setup_channel_mapping			= hdmi_setup_channel_mapping,
	.channel_allocation			= hdmi_channel_allocation,
	.get_cap_from_ca			= hdmi_get_ch_alloc_from_ca,
	.alsa_chmap_to_spk_mask			= to_spk_mask,
	.spk_to_alsa_chmap			= spk_to_chmap,
};

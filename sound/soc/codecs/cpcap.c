...
static const char * const cpcap_input_right_mux_texts[] = {
	"Off", "Mic 1", "Headset Mic", "EMU Mic", "Ext Right"
};

static const char * const cpcap_input_left_mux_texts[] = {
	"Off", "Mic 2", "Ext Left"
};
 ...
 */
static const SOC_ENUM_SINGLE_EXT_DECL(cpcap_input_left_mux_enum,
				      cpcap_input_left_mux_texts);
static const SOC_ENUM_SINGLE_EXT_DECL(cpcap_input_right_mux_enum,
				      cpcap_input_right_mux_texts);
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"Right Capture Route", "Ext", "EXTR"},
	{"Left Capture Route", "Mic 2", "MICL"},
	{"Left Capture Route", "Ext", "EXTL"},

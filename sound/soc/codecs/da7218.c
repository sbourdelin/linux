...
static struct da7218_pdata *da7218_of_to_pdata(struct snd_soc_codec *codec)
{
	...
	if (of_property_read_u32(np, "dlg,dmic1-clkrate-hertz", &of_val32) >= 0)
	...
	if (of_property_read_u32(np, "dlg,dmic2-clkrate-hertz", &of_val32) >= 0)
	...
	if (da7218->dev_id == DA7218_DEV_ID) {
		...
		if (of_property_read_u32(hpldet_np, "dlg,jack-rate-microsecond",
					 &of_val32) >= 0)
		...
		if (of_property_read_u32(hpldet_np, "dlg,jack-threshold-percent",
					 &of_val32) >= 0)

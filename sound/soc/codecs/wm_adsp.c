...
/*
 * We only need to ack the IRQ on the firmware end when we wish to receive
 * another, as such we do this in response to running out of data in the
 * buffer, rather than in direct response to the IRQ itself.
 */

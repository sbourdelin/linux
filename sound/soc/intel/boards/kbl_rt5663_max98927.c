...
#define MX9892700	"i2c-MX98927:00"
#define MX9892701	"i2c-MX98927:01"
...
static int kabylake_rt5663_fe_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	if (ret) {
		dev_err(rtd->dev, "Headset Jack suspend failed %d\n", ret);
		return ret;
	}
	...
	struct snd_pcm_hw_params *params)
{
	...
	/* expected value is (rate << 8) * 2, i.e (48000 << 8) * 2 = 24576000 */
	ret = snd_soc_dai_set_sysclk(codec_dai,
			RT5663_SCLK_S_MCLK, 12288000 * 2, SND_SOC_CLOCK_IN);
	/* Need ASRC because of non integer multiple sys clock. */

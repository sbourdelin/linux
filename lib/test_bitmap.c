...
#define CLUMP_SIZE 4
	...
	bitmap_set(bits, 5, 6);		/* 0x2 */
	bitmap_set(bits, 13, 16);	/* 0xE */
	bitmap_set(bits, 17, 20);	/* 0xE */
	bitmap_set(bits, 20, 24);	/* 0xF */
	bitmap_set(bits, 24, 26);	/* 0x3 */
	bitmap_set(bits, 28, 29);	/* 0x5 - part 1 */
	bitmap_set(bits, 30, 31);	/* 0x5 - part 2 */

...
#define EXYNOS7_DIS_IRQ_ATLAS_CPU0_CPUSEQ_SYS_PWR_REG		(0x100C)
...
#define EXYNOS7_DIS_IRQ_ATLAS_CPU1_CPUSEQ_SYS_PWR_REG		(0x101C)
...
#define EXYNOS7_DIS_IRQ_ATLAS_CPU2_CPUSEQ_SYS_PWR_REG		(0x102C)
...
#define EXYNOS7_DIS_IRQ_ATLAS_CPU3_CPUSEQ_SYS_PWR_REG		(0x103C)
...
#define EXYNOS7_CPU_OPTION(_nr)					\
			(EXYNOS7_ATLAS_CPU0_OPTION + (_nr) * 0x80)
#define EXYNOS7_ATLAS_CPU0_DURATION0				(0x2010)
#define EXYNOS7_CPU_DURATION(_nr)				\
			(EXYNOS7_ATLAS_CPU0_DURATION0 + (_nr) * 0x80)

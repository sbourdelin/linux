...
/*
 * DT property row size for list of BiQuad config data:
 *
 *  <DATA1 ADDR1 ...>
 *
 * where each item is u32 in size, and a row consists of 2 items.
 */
#define DA7218_OF_BIQUAD_CFG_ROW_SIZE	8
#define DA7218_BIQUAD_CFG_PAIR_SIZE	2

struct da7218_pdata {
	/* Internal LDO */
	enum da7218_ldo_lvl_sel ldo_lvl_sel;

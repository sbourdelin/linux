 ...
 * u64 IRQ bits:
 *
 * bit group |dev |mrg0|mrg1|mrg2|mrg3|mrg4|mrg5|mrg6|mrg7| plane0-7  |<unused> |
...
struct tidss_vp_config {
	u32 video_port_width;
};
...
struct dispc_ops {
	...
	void (*vp_enable)(struct dispc_device *dispc,
	...
	void (*vp_set_lcd_config)(struct dispc_device *dispc,
				  u32 hw_videoport,
				  const struct tidss_vp_config *config);
	enum drm_mode_status (*vp_timings_ok)(struct dispc_device *dispc,
					      u32 hw_videoport,
					      const struct videomode *vm);
	void (*vp_set_timings)(struct dispc_device *dispc,
			       u32 hw_videoport,
			       const struct videomode *vm);

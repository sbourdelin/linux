 ...
 *
 * This file is intended as a central place to implement most† of the required
 * workarounds for HW to work as originally intended. They fall in five basic
 ...
 *   be applied from a central place. Those are peppered around the rest of the
 *   code, as needed).
 *

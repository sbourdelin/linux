...
static const struct {
	...
	{REG_A6XX_RBBM_CLOCK_DELAY_SP0, 0x0000f3cf},
	{REG_A6XX_RBBM_CLOCK_DELAY_SP1, 0x0000f3cf},
	{REG_A6XX_RBBM_CLOCK_DELAY_SP2, 0x0000f3cf},
	{REG_A6XX_RBBM_CLOCK_DELAY_SP3, 0x0000f3cf},
	{REG_A6XX_RBBM_CLOCK_HYST_SP0, 0x00000080},
	{REG_A6XX_RBBM_CLOCK_HYST_SP1, 0x00000080},
	{REG_A6XX_RBBM_CLOCK_HYST_SP2, 0x00000080},
	{REG_A6XX_RBBM_CLOCK_HYST_SP3, 0x00000080},
	...
	{REG_A6XX_RBBM_CLOCK_HYST3_TP0, 0x07777777},
	{REG_A6XX_RBBM_CLOCK_HYST3_TP1, 0x07777777},
	{REG_A6XX_RBBM_CLOCK_HYST3_TP2, 0x07777777},
	{REG_A6XX_RBBM_CLOCK_HYST3_TP3, 0x07777777},
	...
	{REG_A6XX_RBBM_CLOCK_DELAY_RAC, 0x00010011},
...
int a6xx_set_hwcg(struct msm_gpu *gpu, bool state)
{
	struct adreno_gpu *adreno_gpu = to_adreno_gpu(gpu);
	struct a6xx_gpu *a6xx_gpu = to_a6xx_gpu(adreno_gpu);
...
static int a6xx_ucode_init(struct msm_gpu *gpu)
{
	...
	if (!a6xx_gpu->sqe_bo) {
		a6xx_gpu->sqe_bo = adreno_request_fw_bo(gpu,
			adreno_gpu->info->pm4fw, &a6xx_gpu->sqe_iova);

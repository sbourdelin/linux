...
static ssize_t power_limit_##index##_##suffix##_show(struct device *dev, \
					...
					char *buf) \
{ \
	BUG_ON(proc_thermal_emum_mode == PROC_THERMAL_NONE); \
...
static int int3401_add(struct platform_device *pdev)
{
	...
	printk(KERN_INFO "Creating sysfs group for PROC_THERMAL_PLATFORM_DEV\n");
				   ...
				   const struct pci_device_id *unused)
{
	...
	printk(KERN_INFO "Creating sysfs group for PROC_THERMAL_PCI\n");

...
/* ARTPEC-6 PCIe driver does not allow module unload */

static int __init artpec6_pcie_init(void)
{
	return platform_driver_probe(&artpec6_pcie_driver, artpec6_pcie_probe);
}
subsys_initcall(artpec6_pcie_init);

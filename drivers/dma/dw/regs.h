...
#define IDMA32C_CTLH_CH_WEIGHT_MASK	GENMASK(28, 18)	/* weight mask */
#define IDMA32C_CTLH_CH_WEIGHT(x)	((x) << 18)	/* weight */
#define IDMA32C_CTLH_CH_CLASS_MASK	GENMASK(31, 29)	/* priority class mask */
#define IDMA32C_CTLH_CH_CLASS(x)	((x) << 29)	/* priority class */

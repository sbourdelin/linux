					    ...
					    void *region_context)
{
	...
	return ti_pmic_common_handler(function, address, bits, value,
				...
				d->get_clk_freq, d->update_clk_freq,
				d->clk_freq_table, d->clk_freq_table_size);
}
				       ...
				       void *region_context)
{
	...
	return ti_pmic_common_handler(function, address, bits, value,
				handler_context, region_context,
				d->get_clk, d->update_clk,
				d->clk_table, d->clk_table_size);
}
					  ...
					  void *region_context)
{
	...
	return ti_pmic_common_handler(function, address, bits, value,
				handler_context, region_context,
				d->get_vr_val, d->update_vr_val,
				d->vr_val_table, d->vr_val_table_size);
}
					 ...
					 void *region_context)
{
	...
	return ti_pmic_common_handler(function, address, bits, value,
				handler_context, region_context,
				d->get_power, d->update_power,
				d->power_table, d->power_table_size);
}
...
{
	struct ti_pmic_opregion_data *d = &ti_tps68470_pmic_opregion_data;

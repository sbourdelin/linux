...
static struct rtl8xxxu_reg32val rtl8192cu_agc_2t_init_table[] = {
	{0xc78, 0x7b000001}, {0xc78, 0x7b010001},
	{0xc78, 0x7b020001}, {0xc78, 0x7b030001},
	{0xc78, 0x7b040001}, {0xc78, 0x7b050001},
	{0xc78, 0x7a060001}, {0xc78, 0x79070001},
...
static void rtl8723a_enable_rf(struct rtl8xxxu_priv *priv)
{
	...
	val32 = rtl8xxxu_read32(priv, REG_FPGA0_XA_RF_PARM);
	val32 &= ~(BIT(4) | BIT(5));
	val32 |= BIT(3);
	rtl8xxxu_write32(priv, REG_FPGA0_XA_RF_PARM, val32);
...
static int rtl8xxxu_init_phy_bb(struct rtl8xxxu_priv *priv)
{
	...
	if (priv->chip == 8192 || priv->chip == 8191) {
		...
		if (priv->tx_paths == 1) {
			...
			rtl8xxxu_write32(priv,
					 REG_OFDM0_TRX_PATH_ENABLE, val32);
		...
		rtl8xxxu_init_phy_regs(priv, rtl8192cu_agc_2t_init_table);
	} else {
				...
				enum rtl8xxxu_rfpath path)
{
	...
	/* For path B, use XB */
	rfsi_rfenv = rtl8xxxu_read16(priv, REG_FPGA0_XA_RF_SW_CTRL);
	...
	rtl8xxxu_write32(priv, REG_FPGA0_XA_HSSI_PARM2, val32);
	udelay(1);
	...
	/* For path B, use XB */
	val16 = rtl8xxxu_read16(priv, REG_FPGA0_XA_RF_SW_CTRL);
	val16 &= ~FPGA0_RF_RFENV;
	val16 |= rfsi_rfenv;
	rtl8xxxu_write16(priv, REG_FPGA0_XA_RF_SW_CTRL, val16);

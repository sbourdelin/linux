...
#define TXDESC_QUEUE_BK			(0x2 << TXDESC_QUEUE_SHIFT)
#define TXDESC_QUEUE_BE			(0x0 << TXDESC_QUEUE_SHIFT)
#define TXDESC_QUEUE_VI			(0x5 << TXDESC_QUEUE_SHIFT)
#define TXDESC_QUEUE_VO			(0x7 << TXDESC_QUEUE_SHIFT)
#define TXDESC_QUEUE_BEACON		(0x10 << TXDESC_QUEUE_SHIFT)
#define TXDESC_QUEUE_HIGH		(0x11 << TXDESC_QUEUE_SHIFT)
#define TXDESC_QUEUE_MGNT		(0x12 << TXDESC_QUEUE_SHIFT)
#define TXDESC_QUEUE_CMD		(0x13 << TXDESC_QUEUE_SHIFT)

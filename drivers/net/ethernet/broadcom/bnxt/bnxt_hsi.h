...
struct hwrm_func_qcfg_output {
	...
	#define FUNC_QCFG_RESP_PORT_PARTITION_TYPE_AFEX	   (0x5UL << 0)
	#define FUNC_QCFG_RESP_PORT_PARTITION_TYPE_UFP		   (0x6UL << 0)
	#define FUNC_QCFG_RESP_PORT_PARTITION_TYPE_BD		   (0x7UL << 0)
	u8 unused_2;
	__le16 dflt_vnic_id;
	u8 unused_3;
	u8 unused_4;
...
struct hwrm_queue_pfcenable_qcfg_output {
	...
	__le16 resp_len;
	__le32 enables;
	#define QUEUE_PFCENABLE_QCFG_RESP_ENABLES_PRI0_PFC_ENABLED 0x1UL
	#define QUEUE_PFCENABLE_QCFG_RESP_ENABLES_PRI1_PFC_ENABLED 0x2UL
	#define QUEUE_PFCENABLE_QCFG_RESP_ENABLES_PRI2_PFC_ENABLED 0x4UL
	#define QUEUE_PFCENABLE_QCFG_RESP_ENABLES_PRI3_PFC_ENABLED 0x8UL
	#define QUEUE_PFCENABLE_QCFG_RESP_ENABLES_PRI4_PFC_ENABLED 0x10UL
	#define QUEUE_PFCENABLE_QCFG_RESP_ENABLES_PRI5_PFC_ENABLED 0x20UL
	#define QUEUE_PFCENABLE_QCFG_RESP_ENABLES_PRI6_PFC_ENABLED 0x40UL
	#define QUEUE_PFCENABLE_QCFG_RESP_ENABLES_PRI7_PFC_ENABLED 0x80UL
	u8 unused_0;
	u8 unused_1;
	u8 unused_2;
	u8 valid;
...
struct hwrm_dbg_read_indirect_input {
	...
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_TE_MGMT_FILTERS_L2 (0x0UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_TE_MGMT_FILTERS_L3L4 (0x1UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_RE_MGMT_FILTERS_L2 (0x2UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_RE_MGMT_FILTERS_L3L4 (0x3UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_STAT_CTXS (0x4UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_TX_L2_TCAM (0x5UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_RX_L2_TCAM (0x6UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_TX_IPV6_SUBNET_TCAM (0x7UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_RX_IPV6_SUBNET_TCAM (0x8UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_TX_SRC_PROPERTIES_TCAM (0x9UL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_RX_SRC_PROPERTIES_TCAM (0xaUL << 0)
	#define DBG_READ_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_VEB_LOOKUP_TCAM (0xbUL << 0)
	u8 unused_0;
	__le16 unused_1;
	__le32 start_index;
...
struct hwrm_dbg_write_indirect_input {
	...
	__le64 resp_addr;
	u8 indirect_access_type;
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_TE_MGMT_FILTERS_L2 (0x0UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_TE_MGMT_FILTERS_L3L4 (0x1UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_RE_MGMT_FILTERS_L2 (0x2UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_RE_MGMT_FILTERS_L3L4 (0x3UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_STAT_CTXS (0x4UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_TX_L2_TCAM (0x5UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_RX_L2_TCAM (0x6UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_TX_IPV6_SUBNET_TCAM (0x7UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_RX_IPV6_SUBNET_TCAM (0x8UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_TX_SRC_PROPERTIES_TCAM (0x9UL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_RX_SRC_PROPERTIES_TCAM (0xaUL << 0)
	#define DBG_WRITE_INDIRECT_REQ_INDIRECT_ACCESS_TYPE_CFA_VEB_LOOKUP_TCAM (0xbUL << 0)
	u8 unused_0;
	__le16 unused_1;
	__le32 start_index;
	__le32 num_of_entries;

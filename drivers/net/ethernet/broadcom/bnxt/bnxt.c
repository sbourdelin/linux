...
static const struct pci_device_id bnxt_pci_tbl[] = {
	{ PCI_VENDOR_ID_BROADCOM, 0x16c9,
	  PCI_ANY_ID, PCI_ANY_ID, 0, 0, BCM57302 },
	{ PCI_VENDOR_ID_BROADCOM, 0x16ca,
	  PCI_ANY_ID, PCI_ANY_ID, 0, 0, BCM57304 },
	{ PCI_VENDOR_ID_BROADCOM, 0x16d1,
	  PCI_ANY_ID, PCI_ANY_ID, 0, 0, BCM57404 },
	{ PCI_VENDOR_ID_BROADCOM, 0x16d2,
	  PCI_ANY_ID, PCI_ANY_ID, 0, 0, BCM57406 },
#ifdef CONFIG_BNXT_SRIOV
	{ PCI_VENDOR_ID_BROADCOM, 0x16cb,
	  PCI_ANY_ID, PCI_ANY_ID, 0, 0, BCM57304_VF },
	{ PCI_VENDOR_ID_BROADCOM, 0x16d3,
	  PCI_ANY_ID, PCI_ANY_ID, 0, 0, BCM57404_VF },
#endif
	{ 0, }
};
...
static void bnxt_disable_poll(struct bnxt_napi *bnapi)
{
#ifdef CONFIG_NET_RX_BUSY_POLL
	int old;
...
static int bnxt_hwrm_ver_get(struct bnxt *bp)
{
	...
	if (req.hwrm_intf_maj != resp->hwrm_intf_maj ||
		...
		netdev_warn(bp->dev, "HWRM interface %d.%d.%d does not match driver interface %d.%d.%d.  Please update driver or firmware with matching interface versions.\n",

...
#define LAN743X_COMPONENT_FLAG_INTR         BIT(1)
#define LAN743X_COMPONENT_FLAG_DP           BIT(2)
#define LAN743X_COMPONENT_FLAG_MAC          BIT(3)
#define LAN743X_COMPONENT_FLAG_PHY          BIT(4)
#define LAN743X_COMPONENT_FLAG_RFE          BIT(5)
#define LAN743X_COMPONENT_FLAG_FCT          BIT(6)

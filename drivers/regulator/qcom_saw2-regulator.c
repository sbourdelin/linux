...
static int saw2_regulator_get_voltage_sel(struct regulator_dev *rdev)
{
...
static void smp_set_vdd(void *data)
{
	...
	timeout = jiffies + usecs_to_jiffies(50);
	do {
...
static struct regulator_ops saw2_regulator_ops = {
	...
	.get_voltage_sel = saw2_regulator_get_voltage_sel,
...
static struct regulator_desc saw2_regulator = {
	...
	.n_linear_ranges = 1,
	.n_voltages = 57,
	.ramp_delay = 1250, /* PMIC internal slew rate is 1250 uV/us */
};

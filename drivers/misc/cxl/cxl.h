...
int cxl_handle_page_fault(bool kernel_context, struct mm_struct *mm, u64 dsisr, u64 dar);
...
int cxl_calc_capp_routing(struct pci_dev *dev, u64 *chipid, u32 *phb_index, u64 *capp_unit_id);

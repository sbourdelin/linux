...
enum rk3399_plls {
	aplll, apllb, dpll, cpll, gpll, npll, vpll,
};
...
PNAME(mux_armclkl_p)				= { "clk_core_l_aplll_src",
						    "clk_core_l_apllb_src",
						    "clk_core_l_dpll_src",
						    "clk_core_l_gpll_src" };
PNAME(mux_armclkb_p)				= { "clk_core_b_aplll_src",
						    "clk_core_b_apllb_src",
						    "clk_core_b_dpll_src",
						    "clk_core_b_gpll_src" };
PNAME(mux_ddrc_p)				= { "clk_ddrc_aplll_src",
						    "clk_ddrc_apllb_src",
						    "clk_ddrc_dpll_src",
						    "clk_ddrc_gpll_src" };
...
static struct rockchip_pll_clock rk3399_pll_clks[] __initdata = {
	[aplll] = PLL(pll_rk3399, PLL_APLLL, "aplll", mux_pll_p, 0, RK3399_PLL_CON(0),
		     RK3399_PLL_CON(3), 8, 31, 0, rk3399_pll_rates),
	[apllb] = PLL(pll_rk3399, PLL_APLLB, "apllb", mux_pll_p, 0, RK3399_PLL_CON(8),
...
static struct rockchip_clk_branch rk3399_clk_branches[] __initdata = {
	...
	/* little core */
	GATE(0, "clk_core_l_aplll_src", "aplll", CLK_IGNORE_UNUSED,
			RK3399_CLKGATE_CON(0), 0, GFLAGS),
	GATE(0, "clk_core_l_apllb_src", "apllb", CLK_IGNORE_UNUSED,
	...
	/* big core */
	GATE(0, "clk_core_b_aplll_src", "aplll", CLK_IGNORE_UNUSED,
			RK3399_CLKGATE_CON(1), 0, GFLAGS),
	GATE(0, "clk_core_b_apllb_src", "apllb", CLK_IGNORE_UNUSED,
	...
	/* ddrc */
	GATE(0, "clk_ddrc_aplll_src", "aplll", CLK_IGNORE_UNUSED,
			RK3399_CLKGATE_CON(3), 0, GFLAGS),
	GATE(0, "clk_ddrc_apllb_src", "apllb", CLK_IGNORE_UNUSED,

...
#include <dt-bindings/clock/rk312x-cru.h>
#include "clk.h"

#define RK312X_GRF_SOC_STATUS0	0x14c

enum rk312x_plls {
	apll, dpll, cpll, gpll,
};

static struct rockchip_pll_rate_table rk312x_pll_rates[] = {
...
#define RK312X_DIV_CPU_MASK		0x1f
#define RK312X_DIV_CPU_SHIFT		8

#define RK312X_DIV_PERI_MASK		0xf
#define RK312X_DIV_PERI_SHIFT		0
#define RK312X_DIV_ACLK_MASK		0x7
#define RK312X_DIV_ACLK_SHIFT		4
#define RK312X_DIV_HCLK_MASK		0x3
#define RK312X_DIV_HCLK_SHIFT		8
#define RK312X_DIV_PCLK_MASK		0x7
#define RK312X_DIV_PCLK_SHIFT		12

#define RK312X_CLKSEL1(_core_aclk_div, _pclk_dbg_div)			\
{									\
	.reg = RK2928_CLKSEL_CON(1),					\
	.val = HIWORD_UPDATE(_pclk_dbg_div, RK312X_DIV_PERI_MASK,	\
			     RK312X_DIV_PERI_SHIFT) |			\
	       HIWORD_UPDATE(_core_aclk_div, RK312X_DIV_ACLK_MASK,	\
			     RK312X_DIV_ACLK_SHIFT),			\
}

#define RK312X_CPUCLK_RATE(_prate, _core_aclk_div, _pclk_dbg_div)	\
{									\
	.prate = _prate,						\
	.divs = {							\
		RK312X_CLKSEL1(_core_aclk_div, _pclk_dbg_div),		\
	},								\
}

static struct rockchip_cpuclk_rate_table rk312x_cpuclk_rates[] __initdata = {
	RK312X_CPUCLK_RATE(1800000000, 1, 7),
	RK312X_CPUCLK_RATE(1704000000, 1, 7),
	RK312X_CPUCLK_RATE(1608000000, 1, 7),
	RK312X_CPUCLK_RATE(1512000000, 1, 7),
	RK312X_CPUCLK_RATE(1488000000, 1, 5),
	RK312X_CPUCLK_RATE(1416000000, 1, 5),
	RK312X_CPUCLK_RATE(1392000000, 1, 5),
	RK312X_CPUCLK_RATE(1296000000, 1, 5),
	RK312X_CPUCLK_RATE(1200000000, 1, 5),
	RK312X_CPUCLK_RATE(1104000000, 1, 5),
	RK312X_CPUCLK_RATE(1008000000, 1, 5),
	RK312X_CPUCLK_RATE(912000000, 1, 5),
	RK312X_CPUCLK_RATE(816000000, 1, 3),
	RK312X_CPUCLK_RATE(696000000, 1, 3),
	RK312X_CPUCLK_RATE(600000000, 1, 3),
	RK312X_CPUCLK_RATE(408000000, 1, 1),
	RK312X_CPUCLK_RATE(312000000, 1, 1),
	RK312X_CPUCLK_RATE(216000000,  1, 1),
	RK312X_CPUCLK_RATE(96000000, 1, 1),
};

static const struct rockchip_cpuclk_reg_data rk312x_cpuclk_data = {
...
static struct rockchip_pll_clock rk312x_pll_clks[] __initdata = {
	[apll] = PLL(pll_rk3036, PLL_APLL, "apll", mux_pll_p, 0, RK2928_PLL_CON(0),
		     RK2928_MODE_CON, 0, 1, 0, rk312x_pll_rates),
	...
	[cpll] = PLL(pll_rk3036, PLL_CPLL, "cpll", mux_pll_p, 0, RK2928_PLL_CON(8),
		     RK2928_MODE_CON, 8, 2, 0, rk312x_pll_rates),
	[gpll] = PLL(pll_rk3036, PLL_GPLL, "gpll", mux_pll_p, 0, RK2928_PLL_CON(12),
		     RK2928_MODE_CON, 12, 3, ROCKCHIP_PLL_SYNC_RATE, rk312x_pll_rates),
};
...
static struct rockchip_clk_branch rk312x_i2s0_fracmux __initdata =
	MUX(0, "i2s0_pre", mux_i2s0_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(9), 8, 2, MFLAGS);

static struct rockchip_clk_branch rk312x_i2s1_fracmux __initdata =
	MUX(0, "i2s1_pre", mux_i2s1_pre_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(3), 8, 2, MFLAGS);

static struct rockchip_clk_branch rk312x_spdif_fracmux __initdata =
	MUX(SCLK_SPDIF, "sclk_spdif", mux_sclk_spdif_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(6), 8, 2, MFLAGS);

static struct rockchip_clk_branch rk312x_uart0_fracmux __initdata =
	MUX(SCLK_UART0, "sclk_uart0", mux_uart0_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(13), 8, 2, MFLAGS);

static struct rockchip_clk_branch rk312x_uart1_fracmux __initdata =
	MUX(SCLK_UART1, "sclk_uart1", mux_uart1_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(14), 8, 2, MFLAGS);

static struct rockchip_clk_branch rk312x_uart2_fracmux __initdata =
	MUX(SCLK_UART2, "sclk_uart2", mux_uart2_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(15), 8, 2, MFLAGS);

static struct rockchip_clk_branch rk312x_clk_branches[] __initdata = {
	/*
	...
	COMPOSITE_FRACMUX(0, "uart0_frac", "uart0_src", CLK_SET_RATE_PARENT,
			...
			&rk312x_uart0_fracmux),
	COMPOSITE_FRACMUX(0, "uart1_frac", "uart1_src", CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(18), 0,
			RK2928_CLKGATE_CON(1), 11, GFLAGS,
			&rk312x_uart1_fracmux),
	COMPOSITE_FRACMUX(0, "uart2_frac", "uart2_src", CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(19), 0,
			RK2928_CLKGATE_CON(1), 13, GFLAGS,
			&rk312x_uart2_fracmux),
...
static const char *const rk312x_critical_clocks[] __initconst = {
	"aclk_cpu",
	"hclk_cpu",
	"pclk_cpu",
	"aclk_peri",
...
static void __init rk312x_clk_init(struct device_node *np)
{
	...
	rockchip_clk_register_plls(ctx, rk312x_pll_clks,
				   ARRAY_SIZE(rk312x_pll_clks),
				   RK312X_GRF_SOC_STATUS0);
	rockchip_clk_register_branches(ctx, rk312x_clk_branches,
				  ARRAY_SIZE(rk312x_clk_branches));
	rockchip_clk_protect_critical(rk312x_critical_clocks,
				      ARRAY_SIZE(rk312x_critical_clocks));

	rockchip_clk_register_armclk(ctx, ARMCLK, "armclk",
			mux_armclk_p, ARRAY_SIZE(mux_armclk_p),
			&rk312x_cpuclk_data, rk312x_cpuclk_rates,
			ARRAY_SIZE(rk312x_cpuclk_rates));
...
CLK_OF_DECLARE(rk312x_cru, "rockchip,rk312x-cru", rk312x_clk_init);

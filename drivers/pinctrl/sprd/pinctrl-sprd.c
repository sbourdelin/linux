...
enum sprd_pinconf_params {
	...
	SPRD_PIN_CONFIG_PULLUP = PIN_CONFIG_END + 3,
	SPRD_PIN_CONFIG_INPUT_SLEEP = PIN_CONFIG_END + 4,
	SPRD_PIN_CONFIG_OUTPUT_SLEEP = PIN_CONFIG_END + 5,
	SPRD_PIN_CONFIG_PULLUP_SLEEP = PIN_CONFIG_END + 6,
	SPRD_PIN_CONFIG_PULLDOWN_SLEEP = PIN_CONFIG_END + 7,
};
...
static const struct pin_config_item sprd_conf_items[] = {
	...
	PCONFDUMP(SPRD_PIN_CONFIG_PULLUP, "pull up", NULL, true),
	PCONFDUMP(SPRD_PIN_CONFIG_INPUT_SLEEP, "input sleep", NULL, false),
	PCONFDUMP(SPRD_PIN_CONFIG_OUTPUT_SLEEP, "output sleep", NULL, false),
	PCONFDUMP(SPRD_PIN_CONFIG_PULLUP_SLEEP, "pullup sleep", NULL, false),
	PCONFDUMP(SPRD_PIN_CONFIG_PULLDOWN_SLEEP, "pulldown sleep", NULL, false),
};
#endif

...
static void
hfa384x_int_rxmonitor(struct wlandevice *wlandev,
...
static int
unlocked_usbctlx_cancel_async(struct hfa384x *hw,
			      struct hfa384x_usbctlx *ctlx);
...
*	Any
----------------------------------------------------------------*/
static int submit_tx_urb(struct hfa384x *hw, struct urb *tx_urb,
			 gfp_t memflags)
{
...
*	process
----------------------------------------------------------------*/
int hfa384x_drvr_ramdl_write(struct hfa384x *hw, u32 daddr, void *buf,
			     u32 len)
{
	int result = 0;
	int nwrites;
...
static void hfa384x_usbin_callback(struct urb *urb)
{
	...
	struct hfa384x *hw;
	union hfa384x_usbin *usbin =
		(union hfa384x_usbin *)urb->transfer_buffer;

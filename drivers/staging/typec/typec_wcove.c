...
{
	/*
	 * TODO: We need to register power_supply in this driver, and notify the
	 * power supply framework about the levels passed to this callback.
	 */
...
static irqreturn_t wcove_typec_irq(int irq, void *data)
{
	...
	dev_dbg(wcove->dev, "%s: usbc_irq1 0x%x, usbc_irq2 0x%x\n", __func__,
		usbc_irq1, usbc_irq2);
 ...
 *
 * Ideally the platform is able to provide these details, for example with ACPI
 * _DSD properties.
 */
...
static int wcove_typec_probe(struct platform_device *pdev)
{
	...
	irq = regmap_irq_get_virq(pmic->irq_chip_data_level2,

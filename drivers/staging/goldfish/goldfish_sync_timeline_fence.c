...
*goldfish_sync_fence_to_sync_pt(struct dma_fence *fence)
{
...
static void
goldfish_sync_timeline_fence_value_str(struct dma_fence *fence,
				       char *str, int size)
{
...
static void
goldfish_sync_timeline_fence_timeline_value_str(struct dma_fence *fence,
						char *str, int size)
{
	struct goldfish_sync_timeline *parent =
		goldfish_dma_fence_parent(fence);

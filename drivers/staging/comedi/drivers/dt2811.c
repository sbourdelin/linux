...
static const struct comedi_lrange dt2811_pgl_ai_ranges = {
	12, {
		UNI_RANGE(5),		/* range 0: gain=1 */
		UNI_RANGE(0.5),		/* range 1: gain=10 */
		UNI_RANGE(0.05),	/* range 2: gain=100 */
		UNI_RANGE(0.01),	/* range 3: gain=500 */

		BIP_RANGE(5),		/* range 0+4: gain=1 */
		BIP_RANGE(0.5),		/* range 1+4: gain=10 */
		BIP_RANGE(0.05),	/* range 2+4: gain=100 */
		BIP_RANGE(0.01),	/* range 3+4: gain=500 */

		BIP_RANGE(2.5),		/* range 0+8: gain=1 */
		BIP_RANGE(0.25),	/* range 1+8: gain=10 */
		BIP_RANGE(0.025),	/* range 2+8: gain=100 */
		BIP_RANGE(0.005)	/* range 3+8: gain=500 */
	}
};

...
int host_int_disconnect(struct host_if_drv *hif_drv, u16 u16ReasonCode)
{
	int s32Error = 0;
	struct host_if_msg msg;
...
int host_int_ListenStateExpired(struct host_if_drv *hif_drv, u32 u32SessionID)
{
	int s32Error = 0;
	struct host_if_msg msg;
...
int host_int_del_All_Rx_BASession(struct host_if_drv *hif_drv,
				  char *pBSSID,
				  char TID)
{
	int s32Error = 0;
...
int host_int_get_ipaddress(struct host_if_drv *hif_drv, u8 *u16ipadd, u8 idx)
{
	int s32Error = 0;
	struct host_if_msg msg;

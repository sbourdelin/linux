...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE_INTERFACE_CLASS(0x19d2, 0x0602, 0xff) }, /* GosunCn ZTE WeLink ME3630 series (MBIM mode) */
	...
	{ USB_DEVICE_AND_INTERFACE_INFO(ZTE_VENDOR_ID, 0x1428, 0xff, 0xff, 0xff),  /* Telewell TW-LTE 4G v2 */
	  .driver_info = RSVD(2) },
	{ USB_DEVICE_INTERFACE_CLASS(0x19d2, 0x1476, 0xff) }, /* GosunCn ZTE WeLink ME3630 series (ECM/NCM mode) */
